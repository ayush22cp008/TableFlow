...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-gray-950 relative overflow-hidden">
      ...
      <div className="z-10 text-center space-y-8 p-12 backdrop-blur-md bg-surface border border-surface-border rounded-card shadow-card max-w-3xl w-full mx-4">
        <div className="flex items-center justify-center gap-3 mb-2">
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-accent-indigo to-accent-amber">
            TableFlow
          </h1>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
          <Link
            href="/order"
            className="w-full sm:w-auto px-8 py-3 rounded-full bg-accent-indigo hover:bg-accent-indigo-hover text-white font-medium transition-all transform hover:scale-105 shadow-card"
          >
            🍽️ Browse Menu
          </Link>
          <Link
            href="/login"
            className="w-full sm:w-auto px-8 py-3 rounded-full bg-transparent border border-surface-border text-text-secondary font-medium transition-all hover:bg-surface backdrop-blur-sm"
          >
            Sign In / Sign Up
          </Link>
        </div>
